...
| [tasks/refatoracao/](tasks/refatoracao/README.md) | Microetapas da **Fase 3.5 ▶ em andamento, 22/29** — refatoração derivada do documento `12`: corrige os motores de oportunidade, instala o design system que nunca foi instalado e move a camada "e se" para o cliente. |
