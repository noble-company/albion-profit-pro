...
// única via confiável é o fs do Node em tempo de teste. O tsconfig do app não inclui os tipos
// de "node" de propósito (achado W6, mantém o ambiente do browser limpo); esta declaração
// mínima cobre só o que os testes usam.
