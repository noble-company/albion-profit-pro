export interface paths {
    ...
    "/me/saved-crafts": {
        ...
        /** Get Saved Crafts */
        get: operations["get_saved_crafts_me_saved_crafts_get"];
        put?: never;
        /** Post Saved Craft */
        post: operations["post_saved_craft_me_saved_crafts_post"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/me/saved-crafts/{saved_craft_id}": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
        ...
        post?: never;
        /** Remove Saved Craft */
        delete: operations["remove_saved_craft_me_saved_crafts__saved_craft_id__delete"];
        options?: never;
        head?: never;
        patch?: never;
        trace?: never;
...
export interface components {
    schemas: {
        ...
        CraftCompareRequest: {
             ...
             * @default 0
             */
            station_fee_per_100_nutrition: number | string;
            /**
             * Use Focus
             * @default false
             */
         ...
         * @enum {string}
         */
        CraftWarning: "stale_data" | "insufficient_depth" | "no_price" | "no_coverage" | "order_not_guaranteed";
        /**
         * DemandOut
        ...
        RecipeSimulationOut: {
            ...
            silver_cost_per_execution: string;
...
export interface operations {
    ...
    search_item_catalog_items_search_get: {
        parameters: {
            query: {
                ...
                /** @deprecated */
                apenas_craftaveis?: boolean | null;
                limit?: number;
            };
            header?: never;
            path?: never;
    ...
    get_saved_crafts_me_saved_crafts_get: {
        parameters: {
            query: {
                server: "west" | "east" | "europe";
            };
        ...
        responses: {
            ...
            200: {
                ...
                content: {
                    "application/json": components["schemas"]["SavedCraftOut"][];
                };
            };
            /** @description Validation Error */
            422: {
    ...
    post_saved_craft_me_saved_crafts_post: {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
        ...
        requestBody: {
            content: {
                "application/json": components["schemas"]["SavedCraftCreate"];
            };
        };
        responses: {
            /** @description Successful Response */
    ...
    remove_saved_craft_me_saved_crafts__saved_craft_id__delete: {
        parameters: {
            query?: never;
            header?: never;
            path: {
                saved_craft_id: string;
            };
            cookie?: never;
        };
        requestBody?: never;
    ...
    flips_opportunities_flips_get: {
        parameters: {
            query: {
                ...
                subcategory2?: string | null;
                subcategory3?: string | null;
                buy_location_id?: string[] | null;
                sell_location_id?: string[] | null;
                tier?: number[] | null;
                enchantment_level?: number[] | null;
                quality_level?: number[] | null;
