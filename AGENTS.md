...
| `backend/` | **Fase 1 + 1.5 and Fase 2.5 complete; Fase 3 active** | FastAPI/Celery/PostgreSQL/Redis with 281 tests. Realm, rollups, ingest validation, partial-book semantics, static seed and isolated Celery operation are enforced. |
