...
6. Implementation specs live in `docs/tasks/{backend,client,estabilizacao,frontend}/`; current priority is `estabilizacao`. Implement one task at a time in dependency order.
